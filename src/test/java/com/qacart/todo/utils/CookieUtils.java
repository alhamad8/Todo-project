...
/*
this method receive rest assured cookies as a list
by the (for) loop converting the cookies to selenium cookies
and then we add this cookies to the list (seleniumCookies)
finally this method return the (seleniumCookies) list
